...
/*
   Convertit une date stockée AAAA-MM-JJ
   en objet Date JavaScript.
*/

function dateVoyageJS(date) {
...
/*
   Affichage AAAA-MM-JJ → JJ/MM/AAAA
*/
...
function convertirDate(date) {
    ...
    /*
       Vérification que la date existe réellement.
       Exemple : 31/02/2026 sera refusé.
    */

    if (
        dateTest.getFullYear() !== Number(annee) ||
        dateTest.getMonth() !== Number(mois) - 1 ||
        dateTest.getDate() !== Number(jour)
    ) {
        return null;
    }
...
/*
   ...
   1. Voyage du mois actuel
   2. Sinon prochain voyage futur
   3. Sinon dernier voyage connu
*/
...
function afficherVoyageAccueil(
    voyage
) {
